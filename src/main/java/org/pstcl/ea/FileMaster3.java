...
@Entity
@Table(name = "FILE_MASTER_Duplicates")
public class FileMaster3 {
	...
	public FileMaster3(FileMaster fileMaster) {
		super();
	...
	public FileMaster3(Date createDateTime, String meter, Integer dailyRecordCount, Integer dailyRecordNoEnd,
